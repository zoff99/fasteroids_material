...
group = "com.zoffcc.applications.fasteroids_material"
version = "1.0.0"
val appName = "fasteroids_material"
...
compose.desktop {
    ...
    application {
        ...
        jvmArgs += listOf("-Dcom.apple.mrj.application.apple.menu.about.name=Fasteroids")
        jvmArgs += listOf("-Dapple.awt.application.name=Fasteroids")
        ...
        nativeDistributions {
            ...
            description = "Fasteroids Material App"
            copyright = "© 2026 Zoff. All rights reserved."
            vendor = "zoff99"
            ...
            macOS {
                ...
                bundleID = "com.zoffcc.applications.fasteroidsmaterial"
            ...
            windows {
                ...
                menuGroup = "Fasteroids Material"
                // see https://wixtoolset.org/documentation/manual/v3/howtos/general/generate_guids.html
                // and https://www.guidgen.com/
                upgradeUuid = "6561fc23-3d27-48dc-a945-773bcdb694c4"
            }
            linux {
...
val desktopFile = project.file("resources/fasteroids_material.desktop")
...
tasks {
    ...
    val copyAppimageIconfile by registering(Exec::class) {
        ...
        println("iconFile_dst=" + "${linuxAppDir}/fasteroids_material.png")
        @Suppress("RemoveSingleExpressionStringTemplate", "RemoveCurlyBracesFromTemplate")
        println("appName=" + "${appName}")
        commandLine("cp", "-v", linuxIconFile, "${linuxAppDir}/fasteroids_material.png")
    }

    val setAppimageRunfile by registering(Exec::class) {
        workingDir = linuxAppDir
        commandLine("ln", "-sf", "fasteroids_material/bin/fasteroids_material", "AppRun")
    }
